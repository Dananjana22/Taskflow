...
class TasksDatabaseHelper (context: Context):SQLiteOpenHelper(context,DATABASE_NAME,null,
    ...
    fun getAllNotes(): List<Task> {
        ...
        while (cursor.moveToNext()) {
            ...
            val title = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_TITLE))  // Changed to getString()
            val content = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_CONTENT))  // Changed to getString()
